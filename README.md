...
Valid Starting Zones: Temple of Marrs Plane of Knowledge The Nexus Ruined City of Dranik

InI File: MQ\Config\CataKill_[ToonName].ini
...
DoBurns=FALSE - (Turn to TRUE for Partial and Full Burn calls in combat if overwhelmed)
